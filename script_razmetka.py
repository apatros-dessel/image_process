...
parser.add_argument('--code_col', default='gridcode', dest='code_col', help='Название колонки с кодовыми значениями')
...
def get_paths(pout, id, maskid, imgid, quicksizes, original=original):
