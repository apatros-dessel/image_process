...
def CopyComposits(shpfiles, tiffiles, pout):
...
# CopyComposits(shpfiles, tiffiles, pout)
count = {}
for folder in [r'\\172.21.195.2\thematic\!projects\Rucode\images_fin\first_date', r'\\172.21.195.2\thematic\!projects\Rucode\images_fin\second_date']:
    sources = flist(folder_paths(folder,1,'tif'), Name)
    for name in flist(folder_paths(r'\\172.21.195.2\thematic\!projects\Rucode\images_fin\composits\8_ch',1,'tif'), Name):
