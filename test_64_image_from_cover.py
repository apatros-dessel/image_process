...
pin = r'\\172.21.195.2\FTP-Share\ftp\!FINAL_PRODUCTS\1.Эко-мониторинг\Э2Б.Исходная ситуация - незаконные свалки\Тверская область\Torzhokskiy_svalki\Torzokskii\Торжокский 2020.shp'
folder_out = r'\\172.21.195.2\FTP-Share\ftp\!FINAL_PRODUCTS\1.Эко-мониторинг\Э2Б.Исходная ситуация - незаконные свалки\Тверская область\Torzhokskiy_svalki\covers'
make_cover = True
