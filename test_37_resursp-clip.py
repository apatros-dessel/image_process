...
path_in = r'\\172.21.195.2\FTP-Share\ftp\images\102_2020_107' # Путь к исходным сценам Ресурс-П
raster_fullcover = r'\\172.21.195.2\FTP-Share\ftp\images\102_2020_107\102_2020_107_Novokuznezk_RP_PMS.json'      # Путь к файлу покрытия Ресурс-П
vector_path = r'd:\digital_earth\granules_grid.shp'                                         # Путь кфайлу сетки гранул
out_dir = r'e:\rks\resurs_granules_Novokuznetzk'                                                             # Путь к готовым гранулам
...
for fpath in folder_paths(path_in, 1, 'tif'):
    ...
    if re.search(r'^r.*.l2\.tif$', f.lower(), flags=0):
        ...
        json_ = filter_dataset_by_col(raster_fullcover, 'id', id, path_out=tempname('json'))
